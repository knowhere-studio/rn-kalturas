...
- (instancetype)initWithAVPlayer:(AVPlayer *)player screenBounds: (CGRect)screenBounds motionManager:(id<NYT360MotionManagement>)motionManager {
    self = [super init];
    if (self) {
        //CGRect initialSceneFrame = NYT360ViewControllerSceneBoundsForScreenBounds(screenBounds);
        _underlyingSceneSize = screenBounds.size;
        _sceneView = [[SCNView alloc] initWithFrame:screenBounds];
