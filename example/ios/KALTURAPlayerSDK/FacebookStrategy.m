...
- (KPBrowserViewController *)shareWithBrowser:(id<KPShareParams>)params completion:(KPShareCompletionBlock)completion {
...
- (NSURL *)shareURL:(id<KPShareParams>)params {
    ...
    requestString = [requestString stringByReplacingOccurrencesOfString:@"{share.shareURL}" withString:@""];
